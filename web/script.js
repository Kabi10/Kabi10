...
class LanguageManager {
    ...
    setLanguage(lang) {
        ...
        document.documentElement.setAttribute('lang', lang === 'ta' ? 'ta' : lang === 'si' ? 'si' : 'en');
...
class NavigationManager {
    ...
    toggleMobileMenu() {
        ...
        icon.textContent = this.navMenu.classList.contains('active') ? 'close' : 'menu';
    }
...
class AnimationManager {
    ...
    init() {
        ...
        const animateElements = document.querySelectorAll('.feature-card, .step-card, .stat-card, .opportunity-card');
